...
def main() -> int:
    parser = argparse.ArgumentParser(description="Read SelfDev state through the read-only API layer.")
    parser.add_argument(
        "resource",
        choices=["health", "summary", "agents", "tools", "kanban", "artifacts", "state"],
    )
